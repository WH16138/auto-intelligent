...
_red → orange → yellow → green → blue → navy → purple_ 순서로 컬러 박스의 진행을 따라가는것을 추천합니다.
...
## 10. 생성형 AI 사용 고지
- 본 프로젝트 문서/코드 작성과 정리에 생성형 AI 보조 도구(Codex)를 활용했습니다.
- AI가 제안한 내용은 사람이 검토·수정하여 반영했으며, 최종 책임은 프로젝트 작성자에게 있습니다.
